...
CREATE TABLE `student` (
  ...
  `join_school_Year` int(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `study`
  ...
  ADD KEY `study_ibfk_3` (`classID`,`groupID`,`subjectID`);
...
--
-- Các ràng buộc cho bảng `social_activity`
--
ALTER TABLE `social_activity`
  ADD CONSTRAINT `fk_dep` FOREIGN KEY (`departmentID`) REFERENCES `department` (`departmentID`);

--
-- Các ràng buộc cho bảng `student`
--
ALTER TABLE `student`
  ADD CONSTRAINT `fk_dep_id` FOREIGN KEY (`departmentID`) REFERENCES `department` (`departmentID`),
  ADD CONSTRAINT `fk_gvcn_msgv` FOREIGN KEY (`MSGV`) REFERENCES `teacher` (`MSGV`);
...
ALTER TABLE `study`
  ...
  ADD CONSTRAINT `study_ibfk_3` FOREIGN KEY (`classID`,`groupID`,`subjectID`) REFERENCES `groupclass` (`classID`, `groupID`, `subjectID`),
...
--
ALTER TABLE `teacher`
  ADD CONSTRAINT `fk_dep_depID` FOREIGN KEY (`departmentID`) REFERENCES `department` (`departmentID`);

--
-- Các ràng buộc cho bảng `undergraduate`
--
ALTER TABLE `undergraduate`
  ADD CONSTRAINT `fk_mssv_mssv` FOREIGN KEY (`MSSV`) REFERENCES `student` (`MSSV`);

--
-- Các ràng buộc cho bảng `week`
--
ALTER TABLE `week`
  ADD CONSTRAINT `group_class_fk` FOREIGN KEY (`classID`,`groupID`,`subjectID`) REFERENCES `groupclass` (`classID`, `groupID`, `subjectID`) ON DELETE CASCADE;
COMMIT;
